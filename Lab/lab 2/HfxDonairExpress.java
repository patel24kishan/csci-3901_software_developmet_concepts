        ...
        switch (type) {
            ...
            case 1: // Pizza
                ...
                do {
                    ...
                    if (topping.equals("pepperoni") /*|| toppings.contains("pepperoni")*/) 
                    {
                        price+= 1.00;
                    } else if (topping.equals("jalapeno") /*|| toppings.contains("jalapeno")*/) {
                        price+= 0.99;
                    } else if (topping.equals("mushroom") /* || toppings.contains("mushroom")*/) {
                        price+= 0.75;
                    }
